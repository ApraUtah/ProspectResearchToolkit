...
labels <- paste0(df$sector, "\n(", df$count, ")")

# Create donut chart using base R
pie(df$percent, labels = labels, col = rainbow(length(df$sector)),
    main = "Distribution of Records per Sector", radius = 1)
```
