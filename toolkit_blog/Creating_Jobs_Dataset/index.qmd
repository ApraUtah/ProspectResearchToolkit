...
I have my own private dataset from the past two years I've been curating, but the most recent update that's more comprehensive is from the public 2017 CMAP dataset - more info below.
...
# Create the data frame manually (based on the JSON data)
sector_data <- data.frame(
  sector = c("Non-Profit", "Education", "Business Services", "Information Technology",
             "Health Care", "Arts, Entertainment & Recreation", "Finance", "Media",
             "Government", "Accounting & Legal", "Oil, Gas, Energy & Utilities", "Retail",
             "Real Estate", "Manufacturing", "Insurance", "Transportation & Logistics",
             "Travel & Tourism", "Biotech & Pharmaceuticals", "Consumer Services",
             "Construction, Repair & Maintenance", "Telecommunications", "Aerospace & Defense"),
  count = c(113, 58, 52, 32, 31, 23, 18, 17, 15, 15, 10, 8, 7, 7, 7, 4, 4, 3, 2, 2, 1, 1)
)
...
ggplot(sector_data, aes(x = 2, y = percent, fill = sector)) +
  ...
  labs(title = \"Distribution of Records per Sector\")
